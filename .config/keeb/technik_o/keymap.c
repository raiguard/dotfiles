...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MSE] = LAYOUT_ortho_4x12(
    ...
    _______, _______, _______, _______, _______, _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_ACL1, _______,
    _______, _______, _______, _______, _______, _______, NAV,     KC_BTN3, _______, _______, KC_ACL2, _______,
